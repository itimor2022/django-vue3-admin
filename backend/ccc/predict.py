...
gua = input("输入: 上卦数 下卦数 动爻数\n")
shanggua = gua.split()[0]
xiagua = gua.split()[1]
dongyao = gua.split()[2]
...
print("#######################################")
print("本卦如下：")
print(f"上卦为：{shangbengua} {shangtiyong}")
print(f"下卦为：{xiabengua} {xiatiyong}")

print(f"体用关系： {wuhangshengkepanduan(wuhangshu[dingbenguawuhang], wuhangshu[Yongbenguawuhang])}")
print(f"六十四卦卦辞： {baguaguaci(shanggua, xiagua)}")

print("#######################################")
print("互卦如下：")
print(f"上互卦为：{shanghugua} 用")
print(f"体用关系： {wuhangshengkepanduan(wuhangshu[dingbenguawuhang], wuhangshu[shanghuguawuhang])}")
print(f"下互卦为：{xiahugua} 用")
print(f"体用关系： {wuhangshengkepanduan(wuhangshu[dingbenguawuhang], wuhangshu[xiahuguawuhang])}")
print(f"六十四卦卦辞：{baguaguaci(baguashu[shanghuguaguaming], baguashu[xiahuguaguaming])}")

print("#######################################")
print("变卦如下: ")
print(f"上变卦为：{shangbiangua} {shangtiyong}")
if shangtiyong == "用":
    print(f"体用关系: {wuhangshengkepanduan(wuhangshu[dingbenguawuhang], wuhangshu[shangbianguawuhang])}")
print(f"下变卦为：{xiabiangua} {xiatiyong}")
if xiatiyong == "用":
    print(f"体用关系: {wuhangshengkepanduan(wuhangshu[dingbenguawuhang], wuhangshu[xiabianguawuhang])}")
print(f"六十四卦卦辞：{baguaguaci(baguashu[shangbianguaguaming], baguashu[xiabianguaguaming])}")
